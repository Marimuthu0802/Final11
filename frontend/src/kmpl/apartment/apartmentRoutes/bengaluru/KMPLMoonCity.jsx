...
const KMPLMoonCity = () => {
  ...
  const downloadBrochure = () => {
    ...
    link.download = 'KMPL_Moon_City_3BHK_RowHouses_Brochure.pdf';
    ...
    <Container fluid className="p-0 m-0 w-100">
      ...
      <Container fluid className="p-0 m-0">
        <Row className="g-0 w-100 d-flex flex-wrap" style={{ marginTop: '6%' }}>
          <Col xs={12} md={8} className="p-0">
            <img
              src={Tower}
              alt="KMPL-GRAND Moon City Row Houses"
          ...
          <Col xs={12} md={4} className="bg-dark text-white d-flex align-items-center justify-content-center p-3">
            <Card id="enquiry-form" className="p-4 bg-dark text-white border-0 w-100">
              <h4>KMPL-GRAND MOON CITY HIGHLIGHTS</h4>
              <ul>
                <li>Luxury 3BHK Row Houses in Bengaluru</li>
      ...
      <Container className="my-5">
        <Row className="align-items-center">
          ...
          <Col md={6}>
            <h3 className="mb-4">Luxury 3BHK Row Houses in Bengaluru</h3>
            ...
            <p className="fs-5"><strong>3.</strong> Exclusive location in North Bengaluru's premium corridor</p>
      ...
      <Container className="my-5">
        <Row id="gallery">
          <h2 className="fw-bold mb-4 text-center">LIFESTYLE AT MOON CITY</h2>
          <CustomCarousel />
        </Row>
      </Container>
      ...
      <Container className="my-5">
        <Row id="google_map">
          <Col>
            <h3 className="text-center mb-4">PRIME LOCATION IN NORTH BENGALURU</h3>
            <p className="text-center mb-4">
              Our row houses are strategically located with easy access to:
              <br /><br />
              <strong>Tech & Business Hubs:</strong>
              <br />• Manyata Tech Park - 5km
              <br />• Hebbal Industrial Area - 3km  
              <br />• Bangalore International Airport - 15km
              <br /><br />
              <strong>Education:</strong>
              <br />• Canadian International School - 2km
              <br />• Indus International School - 4km
              <br /><br />
              <strong>Healthcare:</strong>  
              <br />• Columbia Asia Hospital - 3km
              <br />• Manipal Hospital - 5km
              <br /><br />
              <strong>Lifestyle:</strong>
              <br />• Phoenix MarketCity - 6km
              <br />• UB City - 12km
            </p>
            <div className="text-center mb-4">
              <Button 
                variant="outline-success" 
                onClick={() => window.open("https://maps.google.com/?q=13.0419,77.5801", "_blank")}
              >
                View Exact Location on Google Maps
              </Button>
            </div>
            <GMap coords={{ lat: 13.0419, lng: 77.5801 }} />
            <p className="text-center mt-4">
              <strong>Connectivity:</strong> 
              <br />• 5 mins from Outer Ring Road
              <br />• 10 mins from Hebbal Flyover
              <br />• 15 mins from Nagawara Metro
              <br />• 20 mins from Kempegowda Airport
            </p>
          </Col>
        </Row>
      </Container>
