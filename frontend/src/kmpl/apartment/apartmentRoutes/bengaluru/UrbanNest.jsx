...
const UrbanNest = () => {
  ...
  const downloadBrochure = () => {
    ...
    link.download = 'Urban_Nest_1BHK_Apartments_Brochure.pdf';
  ...
  return (
    <Container fluid className="p-0 m-0 w-100">
      ...
      <Container fluid className="p-0 m-0">
        <Row className="g-0 w-100 d-flex flex-wrap" style={{ marginTop: '6%' }}>
          <Col xs={12} md={8} className="p-0">
            <img
              src={Tower}
              alt="KMPL-GRAND Urban Nest Apartments"
          ...
          <Col xs={12} md={4} className="bg-dark text-white d-flex align-items-center justify-content-center p-3">
            <Card id="enquiry-form" className="p-4 bg-dark text-white border-0 w-100">
              <h4>KMPL-GRAND URBAN NEST HIGHLIGHTS</h4>
              <ul>
                <li>Compact 1BHK Apartments in Bengaluru</li>
      ...
      <Container className="text-center my-5">
        <Row>
          <h2 className="mb-4">WHY CHOOSE OUR 1BHK APARTMENTS?</h2>
        </Row>
      ...
      <Container className="my-5">
        <Row className="align-items-center">
          ...
          <Col md={6}>
            <h3 className="mb-4">Smart 1BHK Apartments in Bengaluru</h3>
            <p className="fs-5"><strong>1.</strong> Compact 550-650 sq.ft apartments with balcony</p>
            <p className="fs-5"><strong>2.</strong> Efficient 1BHK layout perfect for professionals</p>
            <p className="fs-5"><strong>3.</strong> Strategic location near tech parks with excellent connectivity</p>
            ...
            <Modal show={show} onHide={() => setShow(false)} centered size="lg">
              ...
              <Modal.Body>
                ...
                <ul className="fs-5">
                  ...
                  <li className="mb-2">Balcony with city views</li>
                </ul>
                <h5 className="mt-4 mb-3">Smart Features:</h5>
                <ul className="fs-5">
                  <li className="mb-2">Space-saving storage solutions</li>
                  <li className="mb-2">Pre-wired for smart home automation</li>
      ...
      <Container fluid className="bg-light py-5">
        <Row className="justify-content-center">
          <Col xs={12} className="text-center">
            ...
            <div className="mt-4">
              <h4 className="mb-3">
                {activeFloorPlan === 1 && "Efficient 1BHK Apartment Designs"}
                {activeFloorPlan === 2 && "Premium Interior Finishes"}
                {activeFloorPlan === 3 && "Exclusive Community Amenities"}
              </h4>
              <p className="mb-4 px-5">
                {activeFloorPlan === 1 && "Our 1BHK apartments maximize space efficiency with smart storage solutions, perfect for urban professionals."}
      ...
      <Container className="my-5">
        <Row id="gallery">
          <h2 className="fw-bold mb-4 text-center">LIFESTYLE AT URBAN NEST</h2>
          <CustomCarousel />
        </Row>
      </Container>
