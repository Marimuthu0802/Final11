...
const WhisperingPinesRow = () => {
  ...
  const downloadBrochure = () => {
    ...
    link.download = 'Whispering_Pines_Row_3BHK_Brochure.pdf';
  ...
  return (
    <Container fluid className="p-0 m-0 w-100">
      ...
      <Container fluid className="p-0 m-0">
        <Row className="g-0 w-100 d-flex flex-wrap" style={{ marginTop: '6%' }}>
          <Col xs={12} md={8} className="p-0">
            <img
              src={Tower}
              alt="KMPL-GRAND Whispering Pines Row Houses"
          ...
          <Col xs={12} md={4} className="bg-dark text-white d-flex align-items-center justify-content-center p-3">
            <Card id="enquiry-form" className="p-4 bg-dark text-white border-0 w-100">
              <h4>KMPL-GRAND WHISPERING PINES ROW HIGHLIGHTS</h4>
              <ul>
                <li>Luxury 3BHK Row Houses in Coimbatore</li>
                <li>2000-2400 sq.ft homes with private gardens</li>
      ...
      <Container className="text-center my-5">
        <Row>
          <h2 className="mb-4">WHISPERING PINES ROW - LUXURY LIVING</h2>
        </Row>
      ...
      <Container className="my-5">
        <Row className="align-items-center">
          ...
          <Col md={6}>
            <h3 className="mb-4">Premium 3BHK Row Houses in Coimbatore</h3>
            <p className="fs-5"><strong>1.</strong> Spacious 2000-2400 sq.ft homes with private gardens</p>
            <p className="fs-5"><strong>2.</strong> Premium gated community with 24/7 security</p>
            <p className="fs-5"><strong>3.</strong> Exclusive location in Coimbatore's premium corridor</p>
            <p className="fs-5"><strong>4.</strong> Earthquake-resistant RCC structure with premium materials</p>
            <p className="fs-5"><strong>5.</strong> Private terraces and landscaped gardens</p>
            ...
            <Modal show={show} onHide={() => setShow(false)} centered size="lg">
              ...
              <Modal.Body>
                ...
                <ul className="fs-5">
                  <li className="mb-2">Premium wooden flooring in living area</li>
                  <li className="mb-2">Italian marble in master bedroom</li>
                  ...
                  <li className="mb-2">Branded electrical fittings and smart home wiring</li>
                  <li className="mb-2">Private garden area with landscaping</li>
                </ul>
                <h5 className="mt-4 mb-3">Luxury Features:</h5>
                <ul className="fs-5">
                  <li className="mb-2">Walk-in wardrobes in master bedroom</li>
                  <li className="mb-2">Private terrace with panoramic views</li>
                  <li className="mb-2">Dedicated parking for 2 cars</li>
                  <li className="mb-2">Premium main door with security system</li>
                </ul>
              </Modal.Body>
          ...
          <Col xs={12} className="text-center">
            ...
            <div className="mt-4">
              ...
              <p className="mb-4 px-5">
                {activeFloorPlan === 1 && "Our 3BHK row houses offer generous living spaces with private gardens, perfect for families seeking luxury and privacy."}
                {activeFloorPlan === 2 && "Enjoy high-end finishes including wooden flooring, Italian marble, modular kitchens, and premium bathroom fittings."}
      ...
      <Container className="my-5">
        <Row id="gallery">
          <h2 className="fw-bold mb-4 text-center">LIFESTYLE AT WHISPERING PINES ROW</h2>
          <CustomCarousel />
        </Row>
      </Container>
        ...
        <Row id="google_map">
          <Col>
            ...
            <p className="text-center mb-4">
              ...
              <br />• Tidel Park - 5km
              <br />• Coimbatore IT Park - 4km  
              <br /><br />
              <strong>Education:</strong>
              <br />• PSG College of Technology - 3km
              <br />• Amrita University - 8km
              <br /><br />
              <strong>Healthcare:</strong>  
              <br />• Kovai Medical Center - 4km
              <br />• PSG Hospitals - 3km
              <br /><br />
              <strong>Lifestyle:</strong>
              <br />• Brookefields Mall - 5km
              <br />• Fun Republic Mall - 6km
            </p>
            <div className="text-center mb-4">
              <Button 
                variant="outline-success" 
                onClick={() => window.open("https://maps.google.com/?q=11.0169,76.9553", "_blank")}
              >
                View Exact Location on Google Maps
              </Button>
            </div>
            <GMap coords={{ lat: 11.0169, lng: 76.9553 }} />
          ...
          <Col md={4} className="mb-4">
            <Card className="h-100">
              <Card.Body>
                ...
                <Card.Text>
                  Pay in 24 Easy Installments<br />
                  No Hidden Charges
                </Card.Text>
              </Card.Body>
            </Card>
...
export default WhisperingPinesRow;