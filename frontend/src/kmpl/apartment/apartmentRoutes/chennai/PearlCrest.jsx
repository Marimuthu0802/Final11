...
const PearlCrest = () => {
  ...
  const downloadBrochure = () => {
    ...
    link.download = 'Pearl_Crest_2BHK_Apartments_Brochure.pdf';
  ...
  return (
    <Container fluid className="p-0 m-0 w-100">
      ...
      <Container fluid className="p-0 m-0">
        <Row className="g-0 w-100 d-flex flex-wrap" style={{ marginTop: '6%' }}>
          <Col xs={12} md={8} className="p-0">
            <img
              src={Tower}
              alt="KMPL-GRAND Pearl Crest Apartments"
          ...
          <Col xs={12} md={4} className="bg-dark text-white d-flex align-items-center justify-content-center p-3">
            <Card id="enquiry-form" className="p-4 bg-dark text-white border-0 w-100">
              <h4>KMPL-GRAND PEARL CREST HIGHLIGHTS</h4>
              <ul>
                <li>Premium 2BHK Apartments in Chennai</li>
      ...
      <Container className="text-center my-5">
        <Row>
          <h2 className="mb-4">WHY CHOOSE OUR 2BHK APARTMENTS?</h2>
        </Row>
      ...
      <Container className="my-5">
        <Row className="align-items-center">
          ...
          <Col md={6}>
            <h3 className="mb-4">Premium 2BHK Apartments in Chennai</h3>
            <p className="fs-5"><strong>1.</strong> Spacious 950-1100 sq.ft apartments with balcony</p>
            <p className="fs-5"><strong>2.</strong> Elegant 2BHK layout perfect for nuclear families</p>
          ...
          <Col xs={12} className="text-center">
            ...
            <div className="mt-4">
              ...
              <p className="mb-4 px-5">
                {activeFloorPlan === 1 && "Our 2BHK apartments offer comfortable living spaces with balconies, perfect for families who value modern amenities."}
      ...
      <Container className="my-5">
        <Row id="gallery">
          <h2 className="fw-bold mb-4 text-center">LIFESTYLE AT PEARL CREST</h2>
          <CustomCarousel />
        </Row>
      </Container>
      ...
      <Container className="my-5">
        <Row id="google_map">
          <Col>
            <h3 className="text-center mb-4">PRIME LOCATION IN CHENNAI</h3>
            <p className="text-center mb-4">
              ...
              <br />• Olympia Tech Park - 4km
              <br /><br />
              <strong>Education:</strong>
              <br />• DAV Boys Senior Secondary School - 1km
              <br />• Bala Vidya Mandir - 2km
              <br /><br />
              <strong>Healthcare:</strong>  
              <br />• Apollo Hospitals - 3km
              <br />• Fortis Malar - 4km
              <br /><br />
              <strong>Lifestyle:</strong>
              <br />• Phoenix MarketCity - 2km
              <br />• Forum Vijaya Mall - 3km
            </p>
            <div className="text-center mb-4">
              <Button 
                variant="outline-success" 
                onClick={() => window.open("https://maps.google.com/?q=13.0006,80.2664", "_blank")}
              >
                View Exact Location on Google Maps
              </Button>
            </div>
            <GMap coords={{ lat: 13.0006, lng: 80.2664 }} />
            <p className="text-center mt-4">
              <strong>Connectivity:</strong> 
              <br />• 5 mins from OMR Road
              <br />• 10 mins from ECR Road
              <br />• 15 mins from Thiruvanmiyur Metro
              <br />• 30 mins from Chennai Airport
            </p>
          </Col>
        </Row>
      </Container>
